...
import 'package:quotation_currency_app/app/data/repositories/api/http_variation_repository.dart';
...
void registerInstances() {
  ...
  injector.add<IVariationRepository>(HttpVariationRepository.new);
}
